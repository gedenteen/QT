...
InputDialog_Razumov::InputDialog_Razumov(QWidget* pwgt): QDialog(pwgt)
{
...
QString InputDialog_Razumov::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Razumov::lastName() const
{
